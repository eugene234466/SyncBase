...
$stats_result = pg_query_params($conn, "SELECT 
...
$recent_result = pg_query_params($conn, "SELECT name, email, company, created_at FROM contacts WHERE user_id = $1 ORDER BY created_at DESC LIMIT 5", array($user_id));
?>
